...
const About: React.FC<AboutProps> = ({ onNavigate }) => {
  return (
    <div className="flex flex-col gap-4 animate-in fade-in duration-700 pb-20 text-sm sm:text-base">
      {/* Hero Section */}
      ...
      {/* Mission & Vision */}
      <section id="core-purpose" className="bg-cream-light/50 rounded-[2rem] sm:rounded-[60px] 5xl:rounded-[100px] p-6 sm:p-10 md:p-16 4xl:p-32 5xl:p-48 flex flex-col items-center text-center shadow-inner mt-4">
